...
// --------------------------------------------------------------------------------
//
// ASCOM Telescope driver for ArduinoMount
...
namespace ASCOM.ArduinoMount
{
    //
    // Your driver's DeviceID is ASCOM.ArduinoMount.Telescope
    //
    // The Guid attribute sets the CLSID for ASCOM.ArduinoMount.Telescope
    // The ClassInterface/None addribute prevents an empty interface called
    // _ArduinoMount from being created and used as the [default] interface
    //

    /// <summary>
    /// ASCOM Telescope Driver for ArduinoMount.
    /// </summary>
    [Guid("017109b1-f0ed-41e0-888c-2bf766c74389")]
    ...
    public class Telescope : ITelescopeV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.ArduinoMount.Telescope";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ArduinoMount";
        ...
        /// <summary>
        /// Private variable holding the serial port
        /// </summary>
        private Serial serialPort;

        /// <summary>
        /// Initializes a new instance of the <see cref="ArduinoMount"/> class.
        ...
        public Telescope()
        {
            ...
            tl = new TraceLogger("", "ArduinoMount");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "ArduinoMount Driver. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
        ...
        public string Name
        {
            get
            {
                string name = "ArduinoMount Driver";
