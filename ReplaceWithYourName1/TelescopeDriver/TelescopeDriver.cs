...
//
// ASCOM Telescope driver for TEQ1
//
...
namespace ASCOM.TEQ1.Telescope
{
    ...
    //
    // Your driver's DeviceID is ASCOM.TEQ1.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TEQ1.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _TEQ1 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("6c7862b2-1959-4db7-acf4-4b3360ad7160")]
    [ProgId("ASCOM.TEQ1.Telescope")]
    [ServedClassName("ASCOM Telescope Driver for TEQ1")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TEQ1"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TEQ1.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
